...
const viagensIniciais: Viagem[] = [
  {
    id: 1,
    codigo: "VGM-2026-0841",
    veiculo_placa: "CMB-5523",
    veiculo_modelo: "MB Axor 2644",
    motorista: "Djalma Pereira",
    origem: "Usina de Asfalto — Araçatuba/SP",
    destino: "SP-595 Km 52 — Frente de recapeamento",
    finalidade: "Transporte de CBUQ usinado — camada base",
    centro_custo: "CC-008 — Pavimentação",
    data_saida: "2026-06-28",
    hora_saida: "05:30",
    data_previsao: "2026-06-28",
    km_saida: 184220,
    km_chegada: 0,
    status: "em_andamento",
    carga: "18t CBUQ",
    observacoes: "4ª viagem do dia. Temperatura na saída: 162°C.",
  },
  {
    id: 2,
    codigo: "VGM-2026-0840",
    veiculo_placa: "CMB-6610",
    veiculo_modelo: "Volvo FMX 420 — Tanque",
    motorista: "Gustavo Motoniveladora",
    origem: "Posto BR — Araçatuba/SP",
    destino: "Pátio Central — Araçatuba/SP",
    finalidade: "Abastecimento de frota — diesel S-10",
    centro_custo: "CC-001 — Administração Geral",
    data_saida: "2026-06-28",
    hora_saida: "05:45",
    data_previsao: "2026-06-28",
    km_saida: 211640,
  ...
  {
    id: 3,
    codigo: "VGM-2026-0839",
    veiculo_placa: "PCK-0841",
    veiculo_modelo: "Hilux SRX 4x4 2022",
    motorista: "Carlos Encarregado",
    origem: "Escritório GPL — Araçatuba/SP",
    destino: "DER-SP — São Paulo/SP",
    finalidade: "Entrega de BM-DER-004-01 e documentação contratual",
    centro_custo: "CC-008 — Pavimentação",
    data_saida: "2026-06-28",
    hora_saida: "06:00",
    data_previsao: "2026-06-28",
    ...
    km_chegada: 0,
    status: "em_andamento",
    carga: "Documentação BM",
    observacoes: "Retorno previsto 19h.",
  },
  {
    id: 4,
    codigo: "VGM-2026-0838",
    veiculo_placa: "CMB-5523",
    veiculo_modelo: "MB Axor 2644",
    motorista: "Djalma Pereira",
    origem: "Usina de Asfalto — Araçatuba/SP",
    destino: "SP-595 Km 48 — Frente de recapeamento",
    finalidade: "Transporte de CBUQ — camada capa",
    centro_custo: "CC-008 — Pavimentação",
    data_saida: "2026-06-27",
    hora_saida: "06:30",
    data_previsao: "2026-06-27",
    km_saida: 183820,
    km_chegada: 184020,
    status: "concluida",
    carga: "18t CBUQ",
    observacoes: "3ª viagem do dia 27/06.",
  },
  {
    id: 5,
    codigo: "VGM-2026-0837",
    veiculo_placa: "CMB-4417",
    veiculo_modelo: "Volvo FH460",
    motorista: "Benedito Caminhão",
    origem: "Pátio Central — Araçatuba/SP",
    destino: "Loteamento Industrial Norte — Araçatuba",
    finalidade: "Transporte de brita para base da drenagem",
    centro_custo: "CC-003 — Terraplanagem",
    data_saida: "2026-06-27",
    hora_saida: "07:30",
    data_previsao: "2026-06-27",
    km_saida: 97320,
  ...
  {
    id: 6,
    codigo: "VGM-2026-0820",
    veiculo_placa: "CRT-9910",
    veiculo_modelo: "Carreta Randon RK",
    motorista: "—",
    origem: "Pátio Central — Araçatuba/SP",
    destino: "Pedreira Regional — Birigui/SP",
    finalidade: "Carga de brita para estoque de campo",
    centro_custo: "CC-002 — Conserva DER",
    data_saida: "2026-06-25",
    hora_saida: "05:00",
    data_previsao: "2026-06-25",
    km_saida: 308480,
    km_chegada: 308740,
    status: "concluida",
    carga: '30t brita 3/4"',
    observacoes: "Carreta em manutenção preventiva desde 26/06.",
  },
];
...
const abastecimentos: AbastecimentoRegistro[] = [
  {
    ...
    litros: 280,
    valor_litro: 6.89,
    posto: "Posto Ipiranga — Araçatuba/SP",
    motorista: "Djalma Pereira",
    centro_custo: "CC-008 — Pavimentação",
  },
  {
  ...
  },
  {
    ...
    litros: 55,
    valor_litro: 6.89,
    posto: "Posto Shell — Araçatuba/SP",
    motorista: "Carlos Encarregado",
    centro_custo: "CC-008 — Pavimentação",
  },
  {
